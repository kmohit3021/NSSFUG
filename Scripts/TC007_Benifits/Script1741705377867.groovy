...
WebUI.callTestCase(findTestCase('BENEFITS/BC001_Does the Make Benefit view from the Benefits menu load as expected'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BENEFITS/BC002_Your Benefit applications'), [:], FailureHandling.STOP_ON_FAILURE)
