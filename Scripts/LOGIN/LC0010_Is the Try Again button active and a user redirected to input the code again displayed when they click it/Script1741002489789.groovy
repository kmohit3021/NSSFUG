...
WebUI.click(findTestObject('Object Repository/OR Web/Page_NssfgoApp/button_Try Again'))
...
WebUI.click(findTestObject('Object Repository/OR Web/Page_NssfgoApp/a_Resend Code'))
